...
#[test]
fn injection_script_prefixes_helper_url_and_domestic_relays() {
...
#[test]
fn injection_script_uses_builtin_domestic_relays_without_remote_ads() {
    let script = assets::injection_script(57321);

    assert!(script.contains("codexPlusDomesticRelays"));
    assert!(script.contains("Codex 国内使用"));
