...
def test_inject_file_does_not_expose_packaged_sponsor_images(monkeypatch, tmp_path):
    ...
    assert "sponsor-alipay.jpg" not in captured["evaluated"]
    assert "sponsor-wechat.jpg" not in captured["evaluated"]
