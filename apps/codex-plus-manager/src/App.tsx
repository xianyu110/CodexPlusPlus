      ...
      <Panel>
        ...
        <CardContent>
          <div className="metric-list">
            ...
            <Metric label={t("项目地址")} value="github.com/xianyu110/CodexPlusPlus" />
          </div>
          <Toolbar>
            <Button onClick={() => void actions.openExternalUrl("https://github.com/xianyu110/CodexPlusPlus")} variant="secondary">
              <ExternalLink className="h-4 w-4" />
              {t("打开项目主页")}
            </Button>
            <Button onClick={() => void actions.openExternalUrl("https://github.com/xianyu110/CodexPlusPlus/issues")} variant="secondary">
              <ExternalLink className="h-4 w-4" />
              {t("反馈问题")}
            </Button>
          </Toolbar>
